...
- **Snap step is customizable**: a toolbar number input with preset dropdown (0.1 / 0.25 / 0.5 / 1 / 2 / 5 m) that also accepts any typed value; default 0.5 m. Snap on/off and the step persist in the browser as preferences.
