...
- **Snap click-point marker**: a small dotted green circle marks a *future* position — while drawing, where the click will land when the magnet has fully locked the position; while dragging, the snap intersection the point will jump to on release. It never appears for single-axis proximity or free movement.
